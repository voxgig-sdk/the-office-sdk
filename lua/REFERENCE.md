...
| `episodes` | `table` | No | List of episodes the character appeared in. |
...
| `job` | `table` | Yes | List of jobs the character has. |
...
| `workplace` | `table` | Yes | List of locations a character has worked at. |
...
| `mainCharacters` | `table` | No | Main characters in the episode. |
| `recurringCharacters` | `table` | No | Recurring characters in the episode. |
...
| `supportingCharacters` | `table` | No | Supporting characters in the episode. |
