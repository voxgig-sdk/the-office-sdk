...
The Lua SDK for the TheOffice API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:TheOffice(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── the-office_sdk.lua    -- Main SDK module
...
The main module (`the-office_sdk`) exports the SDK constructor
