...
local TheOfficeSDK = {}
TheOfficeSDK.__index = TheOfficeSDK
...
TheOfficeSDK._make_feature = _make_feature


function TheOfficeSDK.new(options)
  local self = setmetatable({}, TheOfficeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TheOfficeSDK:options_map()
...
function TheOfficeSDK:get_utility()
  return Utility.copy(self._utility)
end


function TheOfficeSDK:get_root_ctx()
  return self._rootctx
end


function TheOfficeSDK:prepare(fetchargs)
...
function TheOfficeSDK:direct(fetchargs)
...
-- by passing it.
function TheOfficeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TheOfficeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TheOfficeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TheOfficeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TheOfficeSDK.new(sdkopts)
  sdk.mode = "test"
