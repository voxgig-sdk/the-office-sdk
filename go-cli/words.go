...
func registerSDKWords(r *eng.Registry, client *sdk.TheOfficeSDK) {
...
func runOp(client *sdk.TheOfficeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
