...
// TheOffice SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TheOfficeSDK::test)
...
{
    private const SDK_CLASS = 'TheOfficeSDK';
    ...
    private const SDK_BASE = 'theoffice_sdk';
