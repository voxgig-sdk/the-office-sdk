...
The PHP SDK for the TheOffice API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->TheOffice(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── theoffice_sdk.php          -- Main SDK class
...
The main class (`theoffice_sdk.php`) exports the SDK class
