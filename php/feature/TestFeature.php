...
// TheOffice SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TheOfficeTestFeature extends TheOfficeBaseFeature
{
    ...
    public function init(TheOfficeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TheOfficeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TheOfficeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TheOfficeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TheOfficeContext $ctx, $op, $args): array
    {
