...
// TheOffice SDK streaming feature
...
class TheOfficeStreamingFeature extends TheOfficeBaseFeature
{
    ...
    private function _iterate(TheOfficeResult $result): \Generator
    {
    ...
    private function _streamable(TheOfficeContext $ctx): bool
    {
