...
class TheOfficeTimeoutFeature extends TheOfficeBaseFeature
{
    ...
    private function _with_timeout(TheOfficeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TheOfficeContext $_ctx, float $ms): void
    {
        $client = $this->client;
