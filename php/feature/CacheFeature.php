...
class TheOfficeCacheFeature extends TheOfficeBaseFeature
{
    ...
    private function _through(TheOfficeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
