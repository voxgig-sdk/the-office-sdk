...
class TheOfficeRbacFeature extends TheOfficeBaseFeature
{
    ...
    private function _required(TheOfficeContext $ctx): ?string
    {
    ...
    private function _reject(TheOfficeContext $ctx, string $required): void
    {
    ...
    private function _track(TheOfficeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
