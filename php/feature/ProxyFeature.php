...
class TheOfficeProxyFeature extends TheOfficeBaseFeature
{
    ...
    public function init(TheOfficeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TheOfficeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
