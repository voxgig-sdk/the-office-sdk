...
|---|---|---|
| `ts/` | @voxgig-sdk/the-office-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/the-office-sdk \
      --repository voxgig-sdk/the-office-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/the-office-sdk` shows it, and
`npm trust revoke @voxgig-sdk/the-office-sdk --id=<id>` removes it.
