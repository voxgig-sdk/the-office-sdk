...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TheOfficeOmni.make_runner(TEST_JSON_FILE, TheOfficeSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TheOfficeOmni.errify(err)
    end
