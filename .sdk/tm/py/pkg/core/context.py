...
from projectname_sdk.core.control import TheOfficeControl
...
class TheOfficeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TheOfficeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TheOfficeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TheOfficeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TheOfficeError(code, msg, self)
