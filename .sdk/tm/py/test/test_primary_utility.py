...
from projectname_sdk import TheOfficeSDK
from projectname_sdk.core.spec import TheOfficeSpec
from projectname_sdk.core.result import TheOfficeResult
from projectname_sdk.core.response import TheOfficeResponse
from projectname_sdk.core.operation import TheOfficeOperation
from projectname_sdk.core.error import TheOfficeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TheOfficeBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return TheOfficeError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TheOfficeSDK.test(None, None)
        ...
        class TestInitFeature(TheOfficeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TheOfficeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TheOfficeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TheOfficeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TheOfficeSDK.test(None, setup_opts)
