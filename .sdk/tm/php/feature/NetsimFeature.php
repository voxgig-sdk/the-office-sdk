...
class TheOfficeNetsimFeature extends TheOfficeBaseFeature
{
    ...
    private function _simulate(TheOfficeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TheOfficeContext $ctx, array $applied): void
    {
        $client = $this->client;
