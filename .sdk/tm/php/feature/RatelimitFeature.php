...
// TheOffice SDK ratelimit feature
...
class TheOfficeRatelimitFeature extends TheOfficeBaseFeature
{
    ...
    private function _acquire(TheOfficeContext $ctx): void
    {
    ...
    private function _track(TheOfficeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
