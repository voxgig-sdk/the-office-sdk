...
// TheOffice SDK clienttrack feature
...
class TheOfficeClienttrackFeature extends TheOfficeBaseFeature
{
    ...
    public function PostConstruct(TheOfficeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TheOffice-SDK';
