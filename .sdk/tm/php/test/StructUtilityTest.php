...
// TheOffice SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TheOfficeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TheOfficeOmni::structfix($now, Struct::undef()))
                        !== json_encode(TheOfficeOmni::structfix($val, Struct::undef()))) {
