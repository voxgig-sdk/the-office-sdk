...
// TheOffice SDK utility: fetcher

class TheOfficeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TheOfficeSDK/1.0)';
    ...
    public static function call(TheOfficeContext $ctx, string $fullurl, array $fetchdef): array
    {
