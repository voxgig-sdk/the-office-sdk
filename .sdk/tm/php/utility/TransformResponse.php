...
// TheOffice SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TheOfficeTransformResponse
{
    public static function call(TheOfficeContext $ctx): mixed
    {
        ...
        $transform = TheOfficeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
