...
class TheOfficeGraphql
{
    ...
    // equivalent.
    public static function body(TheOfficeContext $ctx): mixed
    {
    ...
    public static function errors(TheOfficeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
