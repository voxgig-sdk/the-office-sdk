...
The Ruby SDK for the TheOffice API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `TheOfficeError` (a `StandardError` subclass), so wrap
...
```
rb/
├── TheOffice_sdk.rb       -- Main SDK module
