...
import (
	...
	vs "github.com/voxgig-sdk/the-office-sdk/go/utility/struct"
)

type TheOfficeSDK struct {
	Mode     string
...
func (sdk *TheOfficeSDK) OptionsMap() map[string]any {
...
func (sdk *TheOfficeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TheOfficeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TheOfficeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheOfficeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TheOfficeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TheOfficeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TheOfficeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TheOfficeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheOfficeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TheOfficeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
