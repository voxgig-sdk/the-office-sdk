...
The Golang SDK for the TheOffice API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/the-office-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/the-office-sdk=../path/to/github.com/voxgig-sdk/the-office-sdk
```
...
```
github.com/voxgig-sdk/the-office-sdk/
├── the-office.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/the-office-sdk`) re-exports everything needed
