...
from theoffice_sdk.utility import register

# Load features
from theoffice_sdk.feature.base_feature import TheOfficeBaseFeature
from theoffice_sdk.features import _has_feature, _make_feature
...
class TheOfficeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TheOfficeUtility()
        self._utility = utility

        from theoffice_sdk.config import shared_config
    ...
    def get_utility(self):
        return TheOfficeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TheOfficeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from theoffice_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from theoffice_sdk.entity.episode_entity import EpisodeEntity
    ...
    def Season(self, data=None) -> "SeasonEntity":
        ...
        from theoffice_sdk.entity.season_entity import SeasonEntity
