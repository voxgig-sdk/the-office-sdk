...
class TheOfficeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheOfficeTestRunner.getenv("THEOFFICE_TEST_LIVE")
        override = TheOfficeTestRunner.getenv("THEOFFICE_TEST_OVERRIDE")
        ...
        explain = TheOfficeTestRunner.getenv("THEOFFICE_TEST_EXPLAIN")
