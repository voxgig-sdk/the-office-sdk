...
class TheOfficeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheOfficeTestRunner.getenv("THE_OFFICE_TEST_LIVE")
        override = TheOfficeTestRunner.getenv("THE_OFFICE_TEST_OVERRIDE")
        ...
        explain = TheOfficeTestRunner.getenv("THE_OFFICE_TEST_EXPLAIN")
