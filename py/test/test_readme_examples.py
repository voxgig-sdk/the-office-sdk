# TheOffice SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TheOfficeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TheOfficeSDK(...) and TheOfficeSDK.test(...) become
#      TheOfficeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "theoffice_sdk"
_SDK_CLASS = "TheOfficeSDK"
