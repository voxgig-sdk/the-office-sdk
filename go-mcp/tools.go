...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | episode | season"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TheOfficeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-office_list",
		Description: "List records from TheOffice. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-office_load",
		Description: "Load a single record from TheOffice. " +
...
func runOp(client *sdk.TheOfficeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TheOfficeSDK, name string) (sdk.TheOfficeEntity, error) {
